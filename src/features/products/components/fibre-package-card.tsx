import { QrCodeIcon, WifiIcon } from 'lucide-react'
...
export function FibrePackageCard({ deal }: FibrePackageCardProps) {
  return (
    <li className='rounded-lg border p-4 hover:shadow-md flex flex-col'>
      ...
      <div className='mb-4 flex items-center justify-between'>
        ...
        <div className='text-right'>
          <span className='text-2xl font-bold'>R{deal.price}</span>
