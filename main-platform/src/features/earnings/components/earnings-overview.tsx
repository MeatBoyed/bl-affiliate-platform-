      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <div className="flex items-center space-x-2">
            <CardTitle className="text-base font-normal">Registrations and Earnings</CardTitle>
        ...
        <CardContent>
          <div className="flex flex-col-reverse md:flex-row">
            ...
            <div className="mb-4 grid grid-cols-3 gap-4 md:mb-0 md:ml-4 md:w-[200px] md:grid-cols-1">
              <div>
                <div className="text-sm font-medium text-blue-600">Total Registrations</div>
          ...
          <div className="mt-4 text-xs text-muted-foreground">
            * Earnings are subject to verification and may change based on customer retention.
          </div>
        </CardContent>
      </Card>
  )
...
export function EarningsOverviewCard() {
  return (
    <Card>
    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      <CardTitle className="text-base font-normal">Total Pending Earnings</CardTitle>
